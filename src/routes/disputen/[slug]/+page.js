...
export function load({ params }) {
	...
	if (params.slug === 'corduroy') {
		return {
			...
			content: `Corduroy heeft tijdens de jaarlijkse traditie van de “verroding” dit keer een grote fout gemaakt, het gerucht op Ribbook ging namelijk dat rode muurverf genezende krachten tegen soa’s heeft en een goede antischurft zalf is. Als proefdieren werden natuurlijk de sjaarzen gebruikt, een zwembad werd gevuld met de goedkoopst mogelijke muurverf  want het budget was al lang op door de inflatie van Mark Ratte. Hierna werden de aspirant-kameraden er één voor één ingetakeld, na 5 minuten marineren werden ze er uit gehaald. Het was geslaagd, er was namelijk geen spraak meer van schurft, jammer genoeg (gelukkig) was er ook geen sprake meer van levende sjaarzen. Om de gedachten van de moord lost te laten besloten de levende Corduroyanen dat er maar één oplossing was, namelijk alles was los en vast zit op te snuiven. Het begon bij het bier, maar escaleerde al snel tot rode bakstenen, K en de verf. In deze onnuchtere staat opperde de dictator dat het nu van noodbelang was dat ieders bloed werd gecontroleerd op roodheid en dat de verraders die geen rood bloed hadden werden geofferd. Echter bleek dat deze met drugs dichtgeslibde en verkalkte aderen helemaal geen rood bloed bevatten, hun bloed was namelijk blauw. Terwijl het dispuut leegbloedde herinnerde een groot deel zich opeens, oja, mijn ouders zijn gewoon rijk. 
            Rest In Beace. 
            `
		};
	}
	if (params.slug === '9x7') {
		return {
			...
			content: `Na generaties lang te veel danoontjes met elkaar getongd te hebben, is dit kinderdispuut overleden aan incest. Hun speekselketen was een te hevig ingekleude kleurplaat geworden. Helaas had niemand 9x7 verteld dat incest dus geen wincest is. Misschien hebben mensen ze wel gewaarschuwd, maar waren ze te druk met opblaasitems naar elkaars hoofd aan het gooien of bezig met een oude man vereren die net als zij van kleine kinderen houden. Dit hardnekkige volk heeft er wel decennia over gedaan omdat ze vaak geen daadwerkelijke seks hebben of misschien weten kinderen niet hoe seks eigenlijk werkt. 9x7 was een hardnekkig volk of meer een plaag net zoals het zeer in de weg zitten bij de ingang van de kelderbar. De vraag zal zijn of 9x7 mensen later gaan herinneren. Want het is niet alsof ze zooien, terwijl dat wel in hun dispuutslied wordt gezongen. Misschien moeten we na al die incest ze toch wel gaan cancelen, net als marco borsato van hun dispuutslied. RIP 9x7
	...
	if (params.slug === 'kink-id') {
		return {
            ...
            Ook op deze laatste dag van de werkweek, maakte KINK het befaamde stereotype waar: om 12 lagen ze al te ronken in bed. Terwijl het dispuut droomde over roze en festivals, ging het luchtalarm af. HELP …. IS BINNEN GEVALLEN! KINK, zich onbewust van alle chaos, snurkte heerlijk door. Ook SSR kon de gevallen leden niet meer bereiken. Ze waren al zo lang niet meer op SSR geweest, dat al het contact tussen dispuut en vereniging verloren was. Dan was het toch echt gebeurd: het einde van het KINK-gevoel. 
            `
		};
	}
	if (params.slug === 'bloq') {
	...
	if (params.slug === 'terra-f') {
		return {
			...
			content: `Terra F. ging, om de overvloed aan rug en het gebrek aan ruggengraat te verhelpen en weer een goud dispuut te worden, op zoek naar het echte goud. Als een Terraan over de dam is, dan volgt de rest. En zo geschiedde: Terra Forty-niner, op de mijn in, goed gevoed op schelvispekel en kaas. Helaas vond dit dispuut tijdens hun goudkoorts eerst Fool’s gold en overleed de helft van het dispuut aan arsenicumvergiftiging. Radeloos en vermoeid zocht het ruggendispuut verder, steeds dieper de mijn in. Toen er goud werd gevonden, was er een kort moment van euforie. Eindelijk! Van korte duur, het dispuut had zo ver doorgehakt, dat de mijn instabiel werd en instortte. Zo stierf Terra F. in stilte.  
            `
		};
	}
	...
	if (params.slug === 'kobra') {
		return {
			...
			content: `Het zelf claimende creatieve dispuut zat op een middagje lekker therapeutisch te vingerverven. De creaties zagen er net zo uit als hun mentale gemoedstoestand, niet fraai dus. Niemand wist of het kwam door alle ingeademde loodhoudende verf en terpentine of dat het kwam doordat nachtmerries werkelijk zijn, maar alle creaties kwamen tot leven. Kobranen 

            Ze werden allemaal high van de verflucht. Vervolgens gingen ze ommeletten maken van de eitjes waardoor ze hun eigen lichting in de pan hebben gebakken en hebben opgegeten. Daardoor sterven ze uit.
            `
		};
	}
	...
	if (params.slug === 'supra-modum') {
		return {
			...
			content: `Frat boy dispuut Supra Modum heeft meer overeenkomsten met de VS dan je misschien zou denken als je naar hun kaaskoppen kijkt: veel SOA’s, ongewenste kinderen en een ernstig gebrek aan breincapaciteit. Dit laatste werd ze helaas fataal tijdens de laatste will it fry OA. Want will it fry? Dachten de sumo’s toen ze naar hun balzak keken. Om toch wat potentiële radioactieve schade te voorkomen besloten ze het te proberen op een maagdelijke sjaars. Deze verschroeide helaas zijn hele mannelijkheid en moest daardoor noodgedwongen het dispuut verlaten. Maarja waarom zou je iets niet doen alleen maar omdat het een kutidee is? Vol goede moed hingen ze hun zaakje in de friteuse. 
            Radioactieve schade is een understatement. Misschien was het schaamluis, aids of hun druiper. Of was er toch iemand uitgeschoten bij het roze koeken spel? Er zat in ieder geval iets op de sumo zakken wat er voor zorgde dat de frituur ontplofte en de hele klikfusie onder de gifgroene dampende substantie zat. Er is geen verdere uitleg nodig over de staat van de leden, maar de leden die het overleefden waren in ieder geval geen mannen meer. Dus moest Supra Modum worden opgeheven. Om hun laatste woorden nog te beantwoorden: yes, it will fry.
            `
		};
	}
	if (params.slug === 'cupa') {
